function [clusters, clustersIdx, clusterCenters] = kMeansClustering(dataSet,numClusters,numIterations)
...
%         disp(strcat('Iteration:',{' '},string(iter)));
        dataSetAssignments = [dataSet ones(dataLength,1) (1:1:dataLength)'];
        ...
        for i = 1:numClusters
            ...
            splitIdx(:,:,i) = {dataSetAssignments(dataSetAssignments(:,dataDim+1)==i,3)};
        end
